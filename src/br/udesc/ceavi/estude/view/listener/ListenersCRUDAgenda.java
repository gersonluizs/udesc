...
public class ListenersCRUDAgenda {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    dao.deletar(
                            dao.pesquisarPorId(Agenda.class, java.lang.Integer.parseInt(tela.getTfCodigo().getText()))
                    );
                    ...
                    Logger.getLogger(ListenersCRUDAgenda.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private class btGravarActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            agenda.setDescricao(tela.getTfDescricao().getText());
