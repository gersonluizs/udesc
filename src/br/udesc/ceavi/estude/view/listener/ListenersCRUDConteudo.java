...
public class ListenersCRUDConteudo {
     ...
     */
    public ListenersCRUDConteudo(Conteudo conteudo, FrameCRUD tela) {
        //Define o objeto acao
        this.conteudo = conteudo;

        //Define a tela do cadastro
        this.tela = (FrameCRUDConteudo) tela;
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    dao.deletar(
                            dao.pesquisarPorId(Conteudo.class, java.lang.Integer.parseInt(tela.getTfCodigo().getText()))
                    );
    ...
    private class btGravarActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            conteudo.setDescricao(tela.getTfDescricao().getText());
