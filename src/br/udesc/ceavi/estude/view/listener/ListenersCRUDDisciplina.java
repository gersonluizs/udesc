 ...
 * @author Dell
 */
public class ListenersCRUDDisciplina {

    //Atributo que mantém referência ao objeto da camada de Model    
    private Disciplina disciplina;

    //Atributo que mantém referência a camada View
    private FrameCRUDDisciplina tela;

    /**
     * Construtor do Listener para o CRUD Conteudo
     *
     * @param disciplina Objeto endereco da camada de Model
     * @param tela Objeto tela da camada View
     */
    public ListenersCRUDDisciplina(Disciplina disciplina, FrameCRUD tela) {
        //Define o objeto disciplina
        this.disciplina = disciplina;

        //Define a tela do cadastro
        this.tela = (FrameCRUDDisciplina) tela;
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    dao.deletar(
                            dao.pesquisarPorId(Disciplina.class, java.lang.Integer.parseInt(tela.getTfCodigo().getText()))
                    );
                    ...
                    Logger.getLogger(ListenersCRUDDisciplina.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private class btGravarActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            disciplina.setDescricao(tela.getTfDescricao().getText());
