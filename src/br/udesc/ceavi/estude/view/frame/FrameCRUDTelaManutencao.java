 ...
 * @version 1.0
 */
public class FrameCRUDTelaManutencao extends FrameCRUDManutencao{
    ...
    public FrameCRUDTelaManutencao(String titulo){
    ...
    private void initializeComponents() {
        ...
        panelFormulario.setBorder(BorderFactory.createTitledBorder("Dados da Tela"));
    }
